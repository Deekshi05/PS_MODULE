...
from apps.psmodule.models import DepartmentInfo, Designation, ExtraInfo, HoldsDesignation
...
from apps.psmodule.selectors import ActingRole
from apps.psmodule.services import confirm_delivery, create_stock_entry
