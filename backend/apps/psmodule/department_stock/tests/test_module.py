...
from apps.psmodule.department_stock.api.views import StockListView
...
class DepartmentStockAccessTests(TestCase):
    def setUp(self):
        ...
        self.depadmin_user = User.objects.create_user(
            username="depadmin_cse", password="pass1234"
        )
        self.depadmin_user.role = "depadmin_cse"
        self.non_depadmin_user = User.objects.create_user(
