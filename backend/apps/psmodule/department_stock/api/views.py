...
from apps.psmodule.department_stock.models import Stock, TransferLog, TransferRequest
from apps.psmodule.department_stock.permissions import (
    get_user_depadmin_role,
    get_user_ps_admin_role,
    require_depadmin_role,
)
from apps.psmodule.department_stock.api.serializers import (
    StockSerializer,
